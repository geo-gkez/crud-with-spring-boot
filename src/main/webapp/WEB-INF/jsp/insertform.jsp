<%-- 
    Document   : insertform
    Created on : Jun 21, 2020, 1:22:52 PM
    Author     : georg
--%>
        ...
        <div class="container">
            ...
            <div align="center">
              <h2>Insert New Trainer</h2>          
                ...
                <springForm:form   novalidate="novalidate"  cssClass="needs-validation"   action="/insert" method="post" modelAttribute="newtrainer" >
...
<!--      <input type="text" class="form-control" id="validationServer02" placeholder="Last name"  required>-->
      <springForm:input path="name"  cssClass="form-control" placeholder="First name" required="required" maxlength="45" minlength="2" pattern="[A-Za-z]+$" title="only letters, without spaces (for two or more subjects use - or _)"/>
